...
// the following was replaced by xdr_int() to properly handle
// conversion to 64-bit implementation
...
//		return(0);
	...
	pf = ahheadp->extra;
	ppf = &pf;
	if (!xdr_array(xdrsp, (caddr_t *) ppf, &l, NEXTRAS, sizeof(float), (xdrproc_t) xdr_float))
		return(0);
